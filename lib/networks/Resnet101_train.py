...
class Resnet101_train(Network):
    ...
    def setup(self):
        ...
        (self.feed('bn3a_branch1', 
             ...
             .batch_normalization(relu=True, name='bn3b1_branch2a',is_training=True)
             .conv(3, 3, 128, 1, 1, biased=False, relu=False, name='res3b1_branch2b')
             .batch_normalization(relu=True, name='bn3b1_branch2b',is_training=True)
             .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='res3b1_branch2c')
             .batch_normalization(name='bn3b1_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res3a_relu', 
             ...
             .batch_normalization(relu=True, name='bn3b2_branch2a',is_training=True)
             .conv(3, 3, 128, 1, 1, biased=False, relu=False, name='res3b2_branch2b')
             .batch_normalization(relu=True, name='bn3b2_branch2b',is_training=True)
             .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='res3b2_branch2c')
             .batch_normalization(name='bn3b2_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res3b1_relu', 
             ...
             .batch_normalization(relu=True, name='bn3b3_branch2a',is_training=True)
             .conv(3, 3, 128, 1, 1, biased=False, relu=False, name='res3b3_branch2b')
             .batch_normalization(relu=True, name='bn3b3_branch2b',is_training=True)
             .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='res3b3_branch2c')
             .batch_normalization(name='bn3b3_branch2c',is_training=True,relu=False))
        ...
        (self.feed('bn4a_branch1', 
             ...
             .batch_normalization(relu=True, name='bn4b1_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b1_branch2b')
             .batch_normalization(relu=True, name='bn4b1_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b1_branch2c')
             .batch_normalization(name='bn4b1_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4a_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b2_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b2_branch2b')
             .batch_normalization(relu=True, name='bn4b2_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b2_branch2c')
             .batch_normalization(name='bn4b2_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b1_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b3_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b3_branch2b')
             .batch_normalization(relu=True, name='bn4b3_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b3_branch2c')
             .batch_normalization(name='bn4b3_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b2_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b4_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b4_branch2b')
             .batch_normalization(relu=True, name='bn4b4_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b4_branch2c')
             .batch_normalization(name='bn4b4_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b3_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b5_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b5_branch2b')
             .batch_normalization(relu=True, name='bn4b5_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b5_branch2c')
             .batch_normalization(name='bn4b5_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b4_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b6_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b6_branch2b')
             .batch_normalization(relu=True, name='bn4b6_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b6_branch2c')
             .batch_normalization(name='bn4b6_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b5_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b7_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b7_branch2b')
             .batch_normalization(relu=True, name='bn4b7_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b7_branch2c')
             .batch_normalization(name='bn4b7_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b6_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b8_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b8_branch2b')
             .batch_normalization(relu=True, name='bn4b8_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b8_branch2c')
             .batch_normalization(name='bn4b8_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b7_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b9_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b9_branch2b')
             .batch_normalization(relu=True, name='bn4b9_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b9_branch2c')
             .batch_normalization(name='bn4b9_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b8_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b10_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b10_branch2b')
             .batch_normalization(relu=True, name='bn4b10_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b10_branch2c')
             .batch_normalization(name='bn4b10_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b9_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b11_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b11_branch2b')
             .batch_normalization(relu=True, name='bn4b11_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b11_branch2c')
             .batch_normalization(name='bn4b11_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b10_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b12_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b12_branch2b')
             .batch_normalization(relu=True, name='bn4b12_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b12_branch2c')
             .batch_normalization(name='bn4b12_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b11_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b13_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b13_branch2b')
             .batch_normalization(relu=True, name='bn4b13_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b13_branch2c')
             .batch_normalization(name='bn4b13_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b12_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b14_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b14_branch2b')
             .batch_normalization(relu=True, name='bn4b14_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b14_branch2c')
             .batch_normalization(name='bn4b14_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b13_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b15_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b15_branch2b')
             .batch_normalization(relu=True, name='bn4b15_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b15_branch2c')
             .batch_normalization(name='bn4b15_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b14_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b16_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b16_branch2b')
             .batch_normalization(relu=True, name='bn4b16_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b16_branch2c')
             .batch_normalization(name='bn4b16_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b15_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b17_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b17_branch2b')
             .batch_normalization(relu=True, name='bn4b17_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b17_branch2c')
             .batch_normalization(name='bn4b17_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b16_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b18_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b18_branch2b')
             .batch_normalization(relu=True, name='bn4b18_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b18_branch2c')
             .batch_normalization(name='bn4b18_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b17_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b19_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b19_branch2b')
             .batch_normalization(relu=True, name='bn4b19_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b19_branch2c')
             .batch_normalization(name='bn4b19_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b18_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b20_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b20_branch2b')
             .batch_normalization(relu=True, name='bn4b20_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b20_branch2c')
             .batch_normalization(name='bn4b20_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b19_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b21_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b21_branch2b')
             .batch_normalization(relu=True, name='bn4b21_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b21_branch2c')
             .batch_normalization(name='bn4b21_branch2c',is_training=True,relu=False))
        ...
        (self.feed('res4b20_relu', 
             ...
             .batch_normalization(relu=True, name='bn4b22_branch2a',is_training=True)
             .conv(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b22_branch2b')
             .batch_normalization(relu=True, name='bn4b22_branch2b',is_training=True)
             .conv(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b22_branch2c')
             .batch_normalization(name='bn4b22_branch2c',is_training=True,relu=False))
